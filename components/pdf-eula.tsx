          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              <tr className="border-t border-gray-300">
                ...
                <td className="p-1 ytf-body">{formData.licenseDetails.grantedLicense}</td>
                <td className="p-1 ytf-body">{formData.licenseDetails.licenseDuration}</td>
                <td className="p-1 ytf-body">{formData.licenseDetails.languages}</td>
                <td className="p-1 ytf-body">{formData.licenseDetails.fileFormats}</td>
              </tr>
            </tbody>
          </table>
        </div>
